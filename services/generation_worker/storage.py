"""
Cliente Supabase Storage para el generation_worker.
Copia intencionada de services/api/storage/supabase_client.py
(los contenedores no comparten código fuente).
"""
import logging
import os
